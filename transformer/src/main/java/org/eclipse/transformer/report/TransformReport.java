...
public interface TransformReport {
	 ...
	 * @param inputName The name of the resource which is being processed.
	 */
	void begin(Action action, String inputName);
	 ...
	 *
	 * @param data The initial data being processed.
	 */
	void processInitialData(Object data);
	 ...
	 *
	 * @param data The final data being processed.
	 */
	void processFinalData(Object data);
}
